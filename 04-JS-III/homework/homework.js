...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  let numastr = String(n)
  let primdig = numastr.slice(0,1)
  if (primdig === '9'){return true}
  else {return false}
}
...
function mesesDelAño(array) {
  ...
  var contador = 0
  for (var i = 0; i < array.length; i++){
    if (array[i] === 'Enero'){mesesbuscados.push('Enero');
  contador++}
    else if (array[i] === 'Marzo'){mesesbuscados.push('Marzo');
  contador++}
    else if (array[i] === 'Noviembre'){mesesbuscados.push('Noviembre');
  contador++}
  }
...
function mayorACien(array) {
  ...
  var numsmayor100 = []
  for (var i = 0; i < array.length; i++){
    if (array[i] > 100){numsmayor100.push(array[i])}
  }
  return numsmayor100
}
